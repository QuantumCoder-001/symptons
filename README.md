...
<details>
<summary>Click to view all 132 symptoms</summary>
...
symptom_model.pkl – The trained intelligence

symptom_encoder.pkl – Translates AI numbers into human disease names

symptom_features.json – The master list of 132 symptoms
...
Note: The order of the 0s and 1s must match the symptom_features.json perfectly!
